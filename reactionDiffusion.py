...
# cool animation:
#[   {'DA': {'-': 0.16}, 'DB': {'-': 0.08}, 'f': {'-': 0.06}, 'k': {'-': 0.062}},
    #{'DA': {'-': 0.16}, 'DB': {'-': 0.08}, 'f': {'-': 0.06}, 'k': {'-': 0.062}},
    #{   'DA': {'-': 0.16},
        #'DB': {'-': 0, 'A0': 0.03684375784595034},
        #'f': {'-': 0, 'A1': 0.09871047044333567, 'A2': 0.08247717370174525},
        #'k': {'-': 0, 'A1': 0.028501317338781654}},
    #{   'DA': {'-': 0, 'A2': 0.05397900884524094},
        #'DB': {   '-': 0,
                  #'A0': 0.05970419956481448,
                  #'A1': 0.035322308473025255,
                  #'A2': 0.0806547119682263},
        #'f': {'-': 0, 'A0': 0.015818553677950754, 'A2': 0.082161233978634},
        #'k': {'-': 0, 'A1': 0.02104569215501051, 'B0': 0.025367734010128252}}]
#[   {'DA': {'-': 0.16}, 'DB': {'-': 0.08}, 'f': {'-': 0.06}, 'k': {'-': 0.062}},
    #{   'DA': {'-': 0.16},
        #'DB': {'-': 0, 'A0': 0.09321949349256013, 'B0': 0.015088655297711306},
        #'f': {'-': 0, 'A0': 0.05481681695345419, 'A2': 0.059479883833036346},
        #'k': {   '-': 0,
                 #'A0': 0.0028218995587029564,
                 #'A2': 0.03467669755604058,
                 #'A3': 0.09248162023221251}},
    #{'DA': {'-': 0.16}, 'DB': {'-': 0.08}, 'f': {'-': 0.06}, 'k': {'-': 0.062}},
    #{   'DA': {'-': 0, 'A2': 0.04079414475784226, 'A3': 0.08596101555100841},
        #'DB': {'-': 0, 'A1': 0.01072437664408178, 'B2': 0.06313664112368879},
        #'f': {'-': 0, 'A3': 0.08854804873738628},
        #'k': {'-': 0.062}}]
